...
class Sis3316(object):
    ...
    def readout(self, chan_no, target, target_skip=0, opts=None):
        """ Rerurns ITERATOR. """
        if opts is None:
            opts = {}
    ...
    def readout_pipe(self, chan_no, target, target_skip=0, opts=None):
        """ Readout generator. """
        if opts is None:
            opts = {}
    ...
    def readout_last(self, chan_no, target, target_skip=0, opts=None):
